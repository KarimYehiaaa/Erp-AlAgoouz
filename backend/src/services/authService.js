...
const login = async (username, password, meta = {}) => {
  ...
  if (user.locked_until && new Date(user.locked_until) > /* @__PURE__ */ new Date()) {
    const remainingMin = Math.ceil((new Date(user.locked_until).getTime() - (/* @__PURE__ */ new Date()).getTime()) / 6e4);
    throw new AppError(
  ...
  return {
    ...
    token: accessToken,
    refreshToken,
    warning: isDefaultAdminPassword ? "\u062A\u0646\u0628\u064A\u0647 \u0623\u0645\u0646\u064A: \u064A\u0631\u062C\u0649 \u062A\u063A\u064A\u064A\u0631 \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631 \u0627\u0644\u0627\u0641\u062A\u0631\u0627\u0636\u064A\u0629 \u0644\u062D\u0633\u0627\u0628 \u0627\u0644\u0645\u062F\u064A\u0631 \u0644\u062D\u0645\u0627\u064A\u0629 \u0627\u0644\u0646\u0638\u0627\u0645." : void 0
  };
};
