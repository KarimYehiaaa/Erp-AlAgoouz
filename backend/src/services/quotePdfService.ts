...
/**
 * إنشاء ملف PDF لعرض سعر (Quote).
 * @param {Record<string, any>} [payload] بيانات العرض (quote_number، items، company...)
 * @returns {Promise<Buffer>} محتوى ملف PDF
 */
export const generateQuotePdf = async (payload: Record<string, any> = {}) => {
