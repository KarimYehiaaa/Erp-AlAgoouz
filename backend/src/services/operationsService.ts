...
/**
 * جلب سجلات التدقيق (العمليات) مع فلترة وترقيم.
 * @param {Record<string, any>} [filters] خيارات الفلترة (user_id, action, from_date...)
 * @returns {Promise<{ rows: any[], total: number }>}
 */
export const getAuditLogs = async (filters: Record<string, any> = {}) => {
...
/**
 * تنبيهات العمليات (محاولات دخول فاشلة، مخزون منخفض...).
 * @returns {Promise<any[]>}
 */
