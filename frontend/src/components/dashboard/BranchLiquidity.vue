<!--
  BranchLiquidity.vue — بطاقة مؤشر سيولة واحتياطي الصندوق للمحل (Battery)
  تعرض لموقع التشغيل مؤشر بطارية يوضح مدى تغطية المصاريف التشغيلية
      ...
      <div class="panel-head">
        <div>
          <h2>
            ...
            مؤشر سيولة واحتياطي الصندوق للمحل
          </h2>
...
/**
 * عنصر بيانات موقع تشغيل واحد لمؤشر السيولة.
 */
